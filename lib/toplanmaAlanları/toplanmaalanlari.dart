...
void main() => runApp(MaterialApp(home: ToplanmaAlanlari()));
...
class _WikipediaExplorerState extends State<ToplanmaAlanlari> {
          ...
          return FloatingActionButton(
            onPressed: () async {
              ...
              Scaffold.of(context).showSnackBar(
                SnackBar(content: Text('$url Favorilere Eklendi.')),
              );
            },
...
class NavigationControls extends StatelessWidget {
  ...
  navigate(BuildContext context, WebViewController controller,
    ...
    if (canNavigate) {
      ...
      Scaffold.of(context).showSnackBar(
        SnackBar(
            content: Text("${goBack ? 'Geri' : 'İleri'} Geçmiş bulunmuyor")),
      );
    }
  }
}
